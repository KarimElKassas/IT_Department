...
class _ConversationScreenState extends State<ConversationScreen> {
          ...
          return Scaffold(
            appBar: AppBar(
              systemOverlayStyle: SystemUiOverlayStyle(
                statusBarColor: lightGreen.withOpacity(0.1),
            ...
            body: Stack(
              children: [
                Container(
                  color: lightGreen.withOpacity(0.10),
  ...
  Widget chatView(BuildContext context, ConversationCubit cubit,
  ...
  Widget buildImageNumbers(
      int index, int imageIndex, ConversationCubit cubit) {
