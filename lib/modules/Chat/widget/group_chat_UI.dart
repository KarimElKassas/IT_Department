...
import '../../GroupChat/conversation/cubit/group_conversation_states.dart';
...
class _GroupChatUIState extends State<GroupChatUI> {
  ...
  Widget recordButton(GroupConversationCubit cubit) {
  ...
  Widget verticalMoveWidget(GroupConversationCubit cubit) {
    return Positioned(
        bottom:
  ...
  Widget horizontalMoveWidget(GroupConversationCubit cubit) {
    return Positioned(
        bottom: 0,
        left: 0,
        child: Card(
  ...
  Widget buildText(GroupConversationCubit cubit) {
  ...
  Widget lockedRecordWidget(GroupConversationCubit cubit) {
    return Positioned(
      bottom: 0,
      right: 0,
      child: Container(
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GroupConversationCubit()..changeOpacity()..getUserData(widget.groupName, widget.groupID),
