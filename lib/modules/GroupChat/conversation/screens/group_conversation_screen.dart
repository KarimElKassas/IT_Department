...
class _GroupConversationScreenState extends State<GroupConversationScreen> {
  ...
  Widget allMessagesWidget(GroupConversationCubit cubit, GroupConversationStates state) {
    return Stack(
      children: [
        SizedBox(
  ...
  Widget imageAndTextMessageView(BuildContext context, GroupConversationCubit cubit,
      int index, GroupConversationStates state) {
                          ...
                          Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontFamily: "Questv",
                                fontSize: 10,
                                color: cubit.chatListReversed[index].senderID == cubit.userID ? white : Colors.black,
                              ),
                            ),
                          ),
                        ],
  ...
  Widget galleryImageMessageView(BuildContext context, GroupConversationCubit cubit,
      int index, GroupConversationStates state) {
    if (cubit.chatListReversed[index].type == "Image" &&
  ...
  Widget buildImageNumbers(int index, int imageIndex, GroupConversationCubit cubit) {
    return Stack(
  ...
  void openImageFullScreen(
      final int indexOfMessage, int indexOfImage, GroupConversationCubit cubit) {
    Navigator.push(
      context,
      MaterialPageRoute(
                  ...
                  child: cubit.chatListReversed[index].senderID ==
                    ...
                    onTap: () {
                      if (cubit.checkForDocumentFile(
                          cubit.chatListReversed[index].fileName, widget.groupName)) {
                        OpenFile.open(
  ...
  Widget audioConversationManagement2(
      BuildContext itemBuilderContext, int index, GroupConversationCubit cubit) {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: CircleAvatar(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: cubit.chatListReversed[index].senderImage,
                          imageBuilder: (context, imageProvider) =>
                              ClipOval(
                                child: FadeInImage(
                                  height: 50,
