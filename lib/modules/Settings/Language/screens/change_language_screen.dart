...
import 'package:it_department/modules/Settings/Language/cubit/change_language_cubit.dart';
...
class ChangeLanguageSettingScreen extends StatelessWidget {
  const ChangeLanguageSettingScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ChangeLanguageCubit()..getCurrentLanguage(),
      child: BlocConsumer<ChangeLanguageCubit, ChangeLanguageStates>(
                            ...
                            Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  AutoSizeText("قم باختيار اللغة  ( العربية / الإنجليزية )",
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            MyRadioGroup<String>.builder(
                              groupValue: currentLanguage == "ar" ? "العربية" : "الإنجليزية",
                              onChanged: (value){
                                if(value == "الإنجليزية"){
