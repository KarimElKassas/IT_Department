...
class ClerkRegisterGetDepartmentManagerSuccessState extends ClerkRegisterStates{}

class ClerkRegisterGetDepartmentManagerErrorState extends ClerkRegisterStates{
  final String error;

  ClerkRegisterGetDepartmentManagerErrorState(this.error);
}
